    ...
    <div>
      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <button type="submit" className=" bg-blue-500 text-white font-bold py-2 px-4 rounded-md mt-4 hover:bg-indigo-600 hover:to-blue-600 transition ease-in-out duration-150">Signup</button>
        </form>
      </div>
    </div>
    </div>
